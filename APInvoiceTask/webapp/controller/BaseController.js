sap.ui.define([
	...
	"use strict";
	return Controller.extend("ui.incture.APInvoiceTask.controller.BaseController", {
		/**
		...
		_getFormFragment: function (sFragmentName) {
			...
			oFormFragment = sap.ui.xmlfragment(this.getView().getId(), "ui.incture.APInvoiceTask.view.fragments." + sFragmentName, this);
