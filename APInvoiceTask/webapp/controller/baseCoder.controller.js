sap.ui.define([
	...
	function (Controller, MessageBox, Calendar, formatter, Export, ExportTypeCSV, History) {
		"use strict";
		return Controller.extend("ui.incture.APInvoiceTask.controller.baseCoder", {
			onInit: function () {
				...
				var sPDFPath = jQuery.sap.getModulePath("ui.incture.APInvoiceTask.css.pdfs", "/Test.pdf");
			...
			_addPdfContentArea: function () {
				...
				if (oSplitter.getContentAreas().length === 1) {
					...
					this.pdfTable = sap.ui.xmlfragment("ui.incture.APInvoiceTask.view.fragment.pdfTable", this);
			...
			_getFormFragment: function (sFragmentName) {
				...
				oFormFragment = sap.ui.xmlfragment(this.getView().getId(), "ui.incture.APInvoiceTask.view.fragment." + sFragmentName, this);
			...
			openFileExplorer: function () {
				...
				if (!this.myDialogFragment) {
					...
					this.myDialogFragment = sap.ui.xmlfragment("ui.incture.APInvoiceTask.view.fragment.openFileExplorer", this);
			...
			onSelectTemplate: function (oEvt) {
				var that = this;
				var templateModel = this.getView().getModel("templateModel");
				that.selectTemplate = sap.ui.xmlfragment("selectTemplate", "ui.incture.APInvoiceTask.view.fragment.selectTemplate", that);
			...
			onSaveTemplate: function (oEvt) {
				...
				if (!bflag) {
					...
					if (!this.saveTemplate) {
						...
						this.saveTemplate = sap.ui.xmlfragment("saveTemplate", "ui.incture.APInvoiceTask.view.fragment.saveTemplate", this);
					}
			...
			paymentTermValueHelp: function (oEvent) {
				...
				if (!this.paymentTermValueHelpDialog) {
					...
					this.paymentTermValueHelpDialog = sap.ui.xmlfragment("paymentTermValueHelpDialog",
						"ui.incture.APInvoiceTask.view.fragment.paymentTermValueHelp", this);
			...
			fnNonPoReject: function () {
				...
				//this.getView().setModel(mRejectModel, "mRejectModel");
				var that = this;
				that.rejectDialog = sap.ui.xmlfragment("rejectDialog", "ui.incture.APInvoiceTask.view.fragment.rejectDialog", that);
