sap.ui.define([
	...
	return Controller.extend("ui.incture.APInvoiceTask.controller.View1", {
		onInit: function () {
			...
			this.table = sap.ui.xmlfragment("ui.incture.APInvoiceTask.view.fragments.inboxTable", this);
