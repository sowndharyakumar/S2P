sap.ui.define([
	...
	return BaseController.extend("ui.incture.APInvoiceTask.controller.App", {
		onInit: function () {
			...
			this.oRouter.attachRoutePatternMatched(function (oEvent) {
				if (oEvent.getParameters().arguments.value && (oEvent.getParameters().arguments.value == "INVOICE" || oEvent.getParameters().arguments
					...
					that.onGo();
				} else if (oEvent.getParameters().arguments.value && !oEvent.getParameters().arguments.value.includes(".") && !oEvent.getParameters().arguments.value.includes("-")) {
