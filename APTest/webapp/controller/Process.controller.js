sap.ui.define([
	...
	return Controller.extend("ui.incture.APTest.controller.Process", {
		onInit: function () {
			var obj = {
				invNo: "",
				InvoiceDate: null,
		...
		onPressNextProcessInvoice: function () {
			...
			if (itemIndex !== -1) {
				if (!this.createMemoFrag) {
					...
					this.createMemoFrag = sap.ui.xmlfragment("ui.incture.APTest.view.Fragments.createMemoFrag", this);
