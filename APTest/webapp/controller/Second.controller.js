sap.ui.define([
	...
	return Controller.extend("ui.incture.APTest.controller.Second", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf ui.incture.APTest.view.Second
		 */
		onInit: function () {
		...
		onPressAttachments: function () {
			if (!this.attachments) {
				...
				this.attachments = sap.ui.xmlfragment("ui.incture.APTest.view.Fragments.attachments", this);
		...
		onPressNextProcessSaveDraft: function () {
			...
			if (!that.commentAndRejection) {
				that.commentAndRejection = sap.ui.xmlfragment("ui.incture.APTest.view.Fragments.SendAsn", this);
